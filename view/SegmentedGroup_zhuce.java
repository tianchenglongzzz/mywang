...
public class SegmentedGroup_zhuce extends RadioGroup {
    ...
    public SegmentedGroup_zhuce(Context context) {
        super(context);
    ...
    public SegmentedGroup_zhuce(Context context, AttributeSet attrs) {
        super(context, attrs);
        resources = getResources();
        mTintColor = resources.getColor(R.color.radio_button_selected_color);
        mUnCheckedTintColor = resources.getColor(R.color.radio_button_unselected_color);
...
//        }
    ...
    private class LayoutSelector {
        ...
        private int getChildren() {
            return SegmentedGroup_zhuce.this.getChildCount();
        }

        private int getChildIndex(View view) {
            return SegmentedGroup_zhuce.this.indexOfChild(view);
        }
