...
/**
 * Created by hopc on 2017/10/20.
 */

public class DaoyuanDialog extends Dialog {
    public DaoyuanDialog(@NonNull Context context) {
        super(context);
    }

    public DaoyuanDialog(@NonNull Context context, @StyleRes int themeResId) {
    ...
    public static class Builder {
        ...
        private View layout;
        private DaoyuanDialog dialog;
        public Builder(Context context) {
            //这里传入自定义的style，直接影响此Dialog的显示效果。style具体实现见style.xml
            dialog = new DaoyuanDialog(context, R.style.Dialog);
         ...
         * @return
         */
        public DaoyuanDialog createSingleButtonDialog() {
            showSingleButton();
         ...
         * @return
         */
        public DaoyuanDialog createTwoButtonDialog() {
            showTwoButton();
