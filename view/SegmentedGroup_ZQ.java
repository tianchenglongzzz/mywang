...
public class SegmentedGroup_ZQ extends RadioGroup {
    ...
    public SegmentedGroup_ZQ(Context context) {
        super(context);
    ...
    public SegmentedGroup_ZQ(Context context, AttributeSet attrs) {
        super(context, attrs);
        resources = getResources();
        mTintColor = resources.getColor(R.color.radio_button_selected_color);
        mUnCheckedTintColor = resources.getColor(R.color.radio_button_unselected_color);
...
//        }
    ...
    private class LayoutSelector {
        ...
        private int getChildren() {
            return SegmentedGroup_ZQ.this.getChildCount();
        }

        private int getChildIndex(View view) {
            return SegmentedGroup_ZQ.this.indexOfChild(view);
        }
