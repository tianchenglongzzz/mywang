 ...
 */
public class TagFlowLayoutPf extends FlowLayout
    ...
    public TagFlowLayoutPf(Context context, AttributeSet attrs, int defStyle) {
    ...
    public TagFlowLayoutPf(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TagFlowLayoutPf(Context context) {
        this(context, null);
    }
