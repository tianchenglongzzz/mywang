...
import com.ruanmeng.share.XieYi;
...
public class CHexConver {
  ...
  public static int In16to10(String str){
        try {
    ...
    public static String In10to16(int num){
        String str="";
    ...
    public static void main(String[] args) {
        System.out.print(In16to10("050a"));
    }

  public  static  String getAdd0X(String  ip){
      String ip2="";
